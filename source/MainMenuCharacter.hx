...
class MainMenuCharacter extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false, ?isPlayState:Bool = true)
	{
		super(x, y);
	...
	/*	if (!curCharacter.startsWith('bf') && isPlayState) {

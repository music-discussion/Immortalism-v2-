...
class OptionsMenu extends MusicBeatState
{
	...
	var options:Array<OptionCategory> = [
		new OptionCategory("Modes", [
			new PussyMode("Turn on Pussy mode and deactivate all mechanics."),
			new HellMode("Turn on Hell Mode and bump up the difficultie a bit.")
		]),
		...
		new OptionCategory("Gameplay", [
			...
			new GraceTmr("Turn off the Grace Timer for the real Chad Input"),#if debug

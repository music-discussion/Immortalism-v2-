...
class ScreenShake extends Option
{
	...
	private override function updateDisplay():String
	{
		return  FlxG.save.data.windowShake ? "Do not Shake Window" : "Shake Window";
	}

}

class PussyMode extends Option
{
	public static var instance:PussyMode;
	...
	public override function press():Bool
	{
		FlxG.save.data.pussyMode = !FlxG.save.data.pussyMode;
		display = updateDisplay();

		FlxG.save.data.hellMode = false;
		HellMode.instance.display = HellMode.instance.updateDisplay();
	...
	private override function updateDisplay():String
	{
		trace('pussyMode is = to ' + FlxG.save.data.pussyMode);
		return  FlxG.save.data.pussyMode ? "Pussy Mode On" : "Pussy Mode Deactivated";
	}

}

class HellMode extends Option
{
	public static var instance:HellMode;
	...
	public override function press():Bool
	{
		...
		PussyMode.instance.display = PussyMode.instance.updateDisplay();
	...
	private override function updateDisplay():String
	{
		trace('hellMode is = to ' + FlxG.save.data.hellMode);
		return  FlxG.save.data.hellMode ? "Hell Mode Activated" : "Virgin Mode On";
	}
...
class MiddleScrollOption extends Option
{
	...
	private override function updateDisplay():String
	{
		return FlxG.save.data.middleScroll ? "MiddleScroll" : "Right Side Scroll";
	}
}

class MiddleScrollOP extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.middleScrollOP = !FlxG.save.data.middleScrollOP;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return FlxG.save.data.middleScrollOP ? "Offset CPU Notes" : "Hide CPU Notes";
	}
}
